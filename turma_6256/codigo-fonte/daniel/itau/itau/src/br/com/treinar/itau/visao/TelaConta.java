...
public class TelaConta {
	...
	private void cadastrarContaPadrao(Conta conta) {
		...
		conta.getPessoa().nome = JOptionPane.showInputDialog("Nome do cliente");
		conta.getPessoa().cpf = Long.parseLong(JOptionPane.showInputDialog("CPF do cliente"));
	}
	
	private void concluirCadastroContaSalario(ContaSalario cs) {
		cs.setDataCreditoSalario(new Date());
	}
	...
	private void concluirCadastroContaPoupanca(ContaPoupanca cp) {
		...
		cp.setDiaBaseDeposito(Integer.parseInt(tarifaStr));
